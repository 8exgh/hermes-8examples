#!/usr/bin/env node
// Set a fresh random password for each <prefix>START..<prefix>COUNT Rocket.Chat
// user and print the list. Run against the Rocket.Chat admin API.
// Env: RC_URL, RC_ADMIN_USER, RC_ADMIN_PASS, PREFIX (default hermes), START (1), COUNT (5)
...
async function main() {
  ...
  console.log(`\n===== ${PREFIX.toUpperCase()} ROCKET.CHAT PASSWORDS =====`);
